...
\begin{resumeSubSectionBody}
    ...
    \begin{resumeDescription}
        \item{\bf Expertise:} \\
            ...
            CMake, Autotools, GCC, Clang, MSVC, PGI,
            Linux \& macOS ELF / Mach-O toolchains,
            \\
            % Libraries
...
\begin{resumeSubSectionBody}
    ...
    \begin{resumeItemize}
        ...
        \item
            ...
            an Irish SME using Nvidia GPUs on Microsoft Azure.
        ...
        \item
            ...
            the centre to allow for the centre to expand.
...
\begin{resumeSubSectionBody}
    ...
    \begin{resumeItemize}
        \item
            ...
            FBQL API to display a the mutual friends a user has with attendees
            of an event.
            Handled events with thousands of attendees within seconds.

        \item
            Analyzed Ruby-on-Rails event ticketing system, identifying the
            root cause of slow-downs and failures for large user-bases.
