...
\begin{center}
    ...
    % Using \raisebox to vertically centre the @ in the line
...
\begin{resumeSubSectionBody}
    ...
    % In the pursuit of developing high quality software, I'm particularly keen
    % to seek out more experienced developers to learn from, and always looking
    % for avenues for my team and I to learn, grow, and improve.
